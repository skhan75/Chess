...
public class King extends Piece {
  ...
  public Collection<Move> calculatedLegalMoves(Board board) {
    ...
    for(final int currenCandidateOffset : CANDIDATE_MOVE_COORDINATE) {
      ...
      if(BoardUtils.isValidTileCoordinate(candidateDestinationCoordinate)) {
        ...
        if(isEightColumnExclusion(this.piecePosition, currenCandidateOffset)
          || isEightColumnExclusion(this.piecePosition, currenCandidateOffset)) {
          continue;
        }
